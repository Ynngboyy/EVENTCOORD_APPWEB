...
// Atrapamos el ID del evento que viene en la URL
...
btnSubir.addEventListener('click', async () => {
    if (!eventoIdActivo) return alert("Error: No se detectó el ID del evento. Vuelve a escanear el QR.");
    ...
    try {
        ...
        if (resCloud.ok) {
            await addDoc(collection(db, "eventos", eventoIdActivo.trim(), "fotos_revision"), {
